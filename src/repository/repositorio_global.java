...
// Repositório para simular o armazenamento em memória (Fase 7)
public class RepositorioGlobal {
    // Listas para armazenamento temporário (simula um banco de dados)
    private final List<Aluno> alunos = new ArrayList<>();
    private final List<Professor> professores = new ArrayList<>();
    private final List<Curso> cursos = new ArrayList<>();
    private final List<Turma> turmas = new ArrayList<>();

    // Singleton Pattern (Garante uma única instância do repositório)
